const defaultMessage: Record<string, string> = {
  ...
  LAB_NOT_FOUND: "조 정보를 찾을 수 없습니다.",
  NEW_LAB_NOT_FOUND: "변경할 조 정보를 찾을 수 없습니다.",
  NO_ACTIVE_REGISTRATION: "활성 신청 정보가 없습니다.",
  ALREADY_HAS_ACTIVE_REGISTRATION: "이미 신청한 조가 있습니다.",
  GRADE_GROUP_MISMATCH: "학년에 맞지 않는 조입니다.",
  SAME_LAB_CHANGE_NOT_ALLOWED: "같은 조로는 변경할 수 없습니다.",
